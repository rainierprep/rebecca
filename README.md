...
## Overview
Our goal for the next eight weeks will be to create a 1-page biographical website about the woman we picked from the hat. We'll do this using HTML, CSS, and Github.
...
## Github Login
Github is a website that you can store your code on and make it easy to work with others. I like to think of it as the Google Drive of Coding.

#### Please follow these steps on your computer:
1. Go to github.com
2. Login to github.com using the following credentials:
```
username: rainierprep
password: mountrainier123
```
3. Find the link with the name of your website subject and click-through
4. **WAIT**
